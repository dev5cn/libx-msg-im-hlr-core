...
#ifndef NE_XMSGIMAUTH_H_
#define NE_XMSGIMAUTH_H_

#include "XmsgNe.h"

class XmsgImAuth: public XmsgNe
{
public:
...
public:
	...
	XmsgImAuth(shared_ptr<XscTcpServer> tcpServer, const string &peer, const string& pwd, const string& alg);
	virtual ~XmsgImAuth();
};
